...
public class GUISettings {
    ...
    private boolean canUsePlayerInventory = true;
    ...
    public ElementResponse getPlayerInventoryResponse() {
        return playerInventoryResponse;
    }

    public void setPlayerInventoryResponse(
        ElementResponse playerInventoryResponse) {
        this.playerInventoryResponse = playerInventoryResponse;
    }

    private ElementResponse playerInventoryResponse;
    ...
    public boolean canUseInPlayerInventory() {
        return canUsePlayerInventory;
    }

    public void setUseInPlayerInventory(boolean b) {
        this.canUsePlayerInventory = b;
    }
